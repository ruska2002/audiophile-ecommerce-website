...
export default function CheckOut() {
  ...
  return (
    <div>
      {" "}
      <p className="uppercase text-black opacity-50 cursor-pointer mt-10">
        Go Back
      </p>
      <form className="bg-[#F1F1F1] flex justify-center pt-20 lg:flex-row gap-3 pb-10">
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-8">
            <div className="bg-white lg:w-[730px] rounded-lg p-8">
              ...
              <p className="uppercase tracking-[1px] text-orange-500 font-semibold mt-16">
                shipping info
              </p>
              ...
              <div className="mt-6 flex justify-around">
                ...
                <div className="flex flex-col gap-4">
                  <label
                    className={`flex items-center gap-4 p-4 border rounded-md cursor-pointer transition-colors w-[209px] ${
                      selected === "e-Money"
                        ? "border-orange-500"
                        : "border-gray-300"
                    }`}
        ...
        <div className="bg-[#ffffff] lg:w-[350px] rounded-lg"></div>
      </form>
    </div>
  );
}
